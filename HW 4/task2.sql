...
INSERT INTO petEvent VALUES
    ...
    UPDATE petEvents SET remark="5 kittens, 3 female, 2 male" WHERE petname="Fluffy" AND eventdate="1995-05-15";
    UPDATE petEvents SET petname="claws" WHERE eventdate="1997-08-03" AND remark="broken rib";
